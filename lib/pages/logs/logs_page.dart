...
class _LogsPageState extends State<LogsPage> {
  ...
  Future<void> _loadLogs() async {
    ...
    try {
      ...
      if (await file.exists()) {
        ...
        final initialCount = _allLines.length < _initialLoadCount ? _allLines.length : _initialLoadCount;
  ...
  void _loadMoreLines() {
    ...
    Future.microtask(() {
      ...
      final linesToLoad = remainingLines < _loadMoreCount ? remainingLines : _loadMoreCount;
