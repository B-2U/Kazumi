...
mixin _$DownloadController on _DownloadController, Store {
  late final _$recordsAtom = Atom(name: '_DownloadController.records', context: context);
  ...
  late final _$_DownloadControllerActionController = ActionController(name: '_DownloadController', context: context);

  @override
  void refreshRecords() {
    final _$actionInfo = _$_DownloadControllerActionController.startAction(name: '_DownloadController.refreshRecords');
    try {
