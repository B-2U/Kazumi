...
class _PlayerItemPanelState extends State<PlayerItemPanel> {
  ...
  Widget get danmakuTextField {
    return Container(
      constraints:
          Utils.isDesktop() ? const BoxConstraints(maxWidth: 500, maxHeight: 33) : const BoxConstraints(maxHeight: 33),
      padding: const EdgeInsets.symmetric(horizontal: 8),
      child: TextField(
        focusNode: textFieldFocus,
        style: TextStyle(fontSize: Utils.isDesktop() ? 15 : 13, color: Colors.white),
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(fontSize: Utils.isDesktop() ? 15 : 13, color: Colors.white60),
          alignLabelWithHint: true,
          contentPadding: EdgeInsets.symmetric(vertical: 8, horizontal: Utils.isDesktop() ? 8 : 12),
          border: OutlineInputBorder(
            borderSide: BorderSide.none,
            borderRadius: BorderRadius.all(Radius.circular(Utils.isDesktop() ? 8 : 20)),
          ),
            ...
            children: [
              TextButton(
                ...
                style: TextButton.styleFrom(
                  foregroundColor:
                      playerController.danmakuOn ? Theme.of(context).colorScheme.onPrimaryContainer : Colors.white60,
  ...
  Widget danmakuOnIcon(BuildContext context) {
    final colorHex = Theme.of(context).colorScheme.primary.toARGB32().toRadixString(16).substring(2);
  ...
  Widget _buildDanmakuToggleButton(BuildContext context) {
    return IconButton(
      ...
      icon: playerController.danmakuLoading
          ...
          : (playerController.danmakuOn ? danmakuOnIcon(context) : cachedDanmakuOffIcon!),
      onPressed: playerController.danmakuLoading
          ? null
          : () {
              widget.handleDanmaku();
            },
      tooltip: playerController.danmakuLoading ? '弹幕加载中...' : (playerController.danmakuOn ? '关闭弹幕' : '打开弹幕'),
    );
  }
        ...
        children: [
          ...
          AnimatedPositioned(
            ...
            child: Visibility(
              visible: !playerController.lockPanel &&
                  (widget.disableAnimations ? playerController.showVideoController : true),
                  ...
                  ? Wrap(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            playerController.currentPosition.compareTo(playerController.playerPosition) > 0
          ...
          (Utils.isDesktop() || !videoPageController.isFullscreen)
              ...
              : Positioned(
                  ...
                  bottom: 0,
                  child: Visibility(
                    visible: widget.disableAnimations ? playerController.showVideoController : true,
                    child: widget.disableAnimations
                        ? leftControlWidget
                        : SlideTransition(position: leftOffsetAnimation, child: leftControlWidget),
                  ),
                ),
          // 自定义顶部组件
          Positioned(
            ...
            child: Visibility(
              ...
              child: widget.disableAnimations
                  ? topControlWidget
                  : SlideTransition(position: topOffsetAnimation, child: topControlWidget),
            ),
          ),
          // 自定义播放器底部组件
          Positioned(
            ...
            child: Visibility(
              ...
              child: widget.disableAnimations
                  ? bottomControlWidget
                  : SlideTransition(position: bottomOffsetAnimation, child: bottomControlWidget),
            ),
          ),
        ],
      );
  ...
  Widget get bottomControlWidget {
    return Observer(builder: (context) {
      return SafeArea(
        ...
        child: MouseRegion(
          cursor: (videoPageController.isFullscreen && !playerController.showVideoController)
            ...
            children: [
              ...
              Padding(
                ...
                child: ProgressBar(
                  thumbRadius: 8,
                  thumbGlowRadius: 18,
                  timeLabelLocation: Utils.isTablet() ? TimeLabelLocation.sides : TimeLabelLocation.none,
                  ...
                  onDragUpdate: (details) => {playerController.currentPosition = details.timeStamp},
                  onDragEnd: () {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    IconButton(
                      color: Colors.white,
                      icon: Icon(playerController.playing ? Icons.pause_rounded : Icons.play_arrow_rounded),
                    ...
                    // 更换选集
                    if (videoPageController.isFullscreen || Utils.isTablet() || Utils.isDesktop())
                      IconButton(
                        color: Colors.white,
                    ...
                    if (!Utils.isDesktop()) ...[
                      IconButton(
                        color: Colors.white,
                        icon: playerController.danmakuOn ? danmakuOnIcon(context) : cachedDanmakuOffIcon!,
                        onPressed: () {
                          widget.handleDanmaku();
                        },
                    ...
                    MenuAnchor(
                      ...
                      menuChildren: List<MenuItemButton>.generate(
                        ...
                        (int index) => MenuItemButton(
                          onPressed: () => widget.handleSuperResolutionChange(index + 1),
                          child: Container(
                            height: 48,
                              ...
                              child: Text(
                                index + 1 == 1
                                    ...
                                    : index + 1 == 2
                                        ...
                                        : '质量档',
                                style: TextStyle(
                                  color: playerController.superResolutionType == index + 1
                    ...
                    MenuAnchor(
                      ...
                      builder: (BuildContext context, MenuController controller, Widget? child) {
                        return TextButton(
                          ...
                          child: Text(
                            playerController.playerSpeed == 1.0 ? '倍速' : '${playerController.playerSpeed}x',
                    ...
                    (!videoPageController.isFullscreen && !Utils.isTablet() && !Utils.isDesktop())
                        ? Container()
                        : IconButton(
                            color: Colors.white,
              ...
              if (Utils.isTablet() || Utils.isDesktop()) const SizedBox(height: 6),
            ],
          ),
        ),
      );
                  ...
                  menuChildren: [
                    ...
                    MenuItemButton(
                      onPressed: () {
                        ...
                        RemotePlay()
                            .castVideo(playerController.videoUrl, videoPageController.currentPlugin.referer)
                            .whenComplete(() {
                          if (needRestart) {
                          ...
                          child: Container(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      !TimedShutdownService().isActive ? Theme.of(context).colorScheme.primary : null,
                                ),
                              ),
                            ),
                          ),
                          ...
                          MenuItemButton(
                            onPressed: () {
                              ...
                              KazumiDialog.showToast(
                                  message: '已设置 ${TimedShutdownService().formatMinutesToDisplay(minutes)} 后定时关闭');
                            },
                            child: Container(
                              height: 48,
                              constraints: BoxConstraints(minWidth: 112),
                      ...
                      menuChildren: [
                        ...
                        MenuItemButton(
                          child: Container(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text("网络延时: ${playerController.syncplayClientRtt}ms"),
                            ),
                          ),
                        ),
                        MenuItemButton(
