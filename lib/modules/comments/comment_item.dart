...
class EpisodeCommentItem {
  ...
  factory EpisodeCommentItem.fromJson(Map<String, dynamic> json) {
    ...
    List<EpisodeComment> tempList = list.map((i) => EpisodeComment.fromJson(i)).toList();
    return EpisodeCommentItem(comment: EpisodeComment.fromJson(json), replies: tempList);
  }
...
class CharacterCommentItem {
  ...
  factory CharacterCommentItem.fromJson(Map<String, dynamic> json) {
    var list = json['replies'] as List;
    List<CharacterComment> tempList = list.map((i) => CharacterComment.fromJson(i)).toList();
    return CharacterCommentItem(comment: CharacterComment.fromJson(json), replies: tempList);
  }
