...
mixin _$PluginsController on _PluginsController, Store {
  late final _$pluginListAtom = Atom(name: '_PluginsController.pluginList', context: context);
  ...
  late final _$pluginHTTPListAtom = Atom(name: '_PluginsController.pluginHTTPList', context: context);
